package extracode;
 ...
 class Employee1 extends CommunityMember
 {
	String qual;
	String nm;
	String address;
	String contact;
	String date;
	Employee1(String qual,String nm,String address,String contact,String date)
	{
 ...
 public class CommunityMemberMain {
	...
	public static void main(String args[])
	{
		...
		Employee1 e=new Employee1("MCA","Arpit","badi gwal toli","9424841743","22 feb");
